...
SECRET_KEY = 'django-insecure-&x0*=ih3&cd!-*58_&099xt2o!hyuuo4*pcjq6ejjnz=d9^o(d'
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',  # 使用 MariaDB 的 MySQL 引擎
        'NAME': 'unityUserDatabase',  # 資料庫名稱
        'USER': 'root', # 資料庫使用者名稱
        'PASSWORD': '517517',   # 資料庫使用者密碼
